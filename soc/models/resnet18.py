...
def _resnet(config, arch, block, layers, progress, **kwargs):
    model = ResNet(config, block, layers, **kwargs)
...
def resnet18(config, progress=True, **kwargs):
    ...
    """
    return _resnet(config, 'resnet18', BasicBlock, [2, 2, 2, 2], progress, **kwargs)


def resnet34(config, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(config, 'resnet34', BasicBlock, [3, 4, 6, 3], progress, **kwargs)


def resnet50(config, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(config, 'resnet50', Bottleneck, [3, 4, 6, 3], progress, **kwargs)


def resnet101(config, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(config, 'resnet101', Bottleneck, [3, 4, 23, 3], progress, **kwargs)


def resnet152(config, progress=True, **kwargs):
    ...
    Args:
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(config, 'resnet152', Bottleneck, [3, 8, 36, 3], progress, **kwargs)


def resnext50_32x4d(config, progress=True, **kwargs):
